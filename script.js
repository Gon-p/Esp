...
accessForm.addEventListener('submit', function (e) {
    ...
    if (passwordInput.value === PASSWORD) {
        ...
        accessMessage.style.color = "#7200ddff";
        ...
        accessMessage.style.color = "#db0f0fff";
...
function createHearts() {
    ...
    for (let i = 0; i < heartCount; i++) {
        ...
        const colors = ['#5f009eff', '#def700ff', '#ff0095ff', '#00fff2ff'];
        ...
        specialMessage.innerHTML = `
                    <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.85); display: flex; justify-content: center; align-items: center; z-index: 2000;">
                        <div style="background: linear-gradient(135deg, #f8d7da, #fad2e1, #fde2e4); padding: 2.5rem; border-radius: 20px; text-align: center; max-width: 90%; max-height: 90%; overflow: auto; box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
                            <h2 style="font-size: 2.5rem; margin-bottom: 1.5rem; color: #73008aff; display: flex; align-items: center; justify-content: center; gap: 15px;">
                                <i class="fas fa-heart" style="color: #630091ff;"></i>A + B<i class="fas fa-heart" style="color: #6604a7ff;"></i>
                            </h2>
                            <p style="font-size: 1.4rem; line-height: 1.6; margin-bottom: 2rem; color: #720081ff;">
                            ...
                            <button id="closeBtn" style="background: #a80a3cff; color: white; border: none; padding: 1rem 2.5rem; border-radius: 50px; font-size: 1.2rem; cursor: pointer; transition: all 0.3s ease;">
                                Cerrar
                            </button>
                        </div>
                    </div>
...
function createConfetti() {
    const colors = ['#b700ffff', '#b8d800ff', '#7d009cff', '#b5d400ff', '#8700a1ff', '#00b7ffff'];
